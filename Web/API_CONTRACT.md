...
### `leave_room`
Voluntarily leave the current game room. The server **dissolves the entire room**. Both players are removed from the Socket.IO room, the room is deleted, and any remaining player is notified.
